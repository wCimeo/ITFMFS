...
export function RoutingView() {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/user/route?${params.toString()}`);
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-zinc-800 transition-colors duration-300">
              <div className="flex items-center justify-between mb-4">
                ...
                <select
                  ...
                  className="bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-lg px-2 py-1 text-sm text-gray-700 dark:text-zinc-300 focus:outline-none"
                >
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-5 rounded-xl border border-emerald-500/30 bg-emerald-50 dark:bg-emerald-500/5 transition-colors duration-300">
                  ...
                  <div className="text-3xl font-light text-emerald-600 dark:text-emerald-400">
                    ...
                    <span className="text-base text-gray-400 dark:text-zinc-500 ml-1">分钟</span>
                  </div>
                </div>
                <div className="p-5 rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 transition-colors duration-300">
                  ...
                  <div className="text-3xl font-light text-gray-900 dark:text-zinc-100">
                    {route.distance}
                    <span className="text-base text-gray-400 dark:text-zinc-500 ml-1">km</span>
                  </div>
                </div>
                <div className="p-5 rounded-xl border border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-900/50 transition-colors duration-300">
                  <div className="text-sm text-gray-500 dark:text-zinc-400 mb-1 flex items-center gap-2">
                  ...
                  <div className="text-3xl font-light text-amber-500 dark:text-amber-400">
                    {route.savings}
                    <span className="text-base text-gray-400 dark:text-zinc-500 ml-1">分钟</span>
                  </div>
                </div>
